...
- `docs/00-project/blueprint.md` — process standard: **WHAT + WHEN** (this document)
- `docs/00-project/guideline.md` — reasoning standard: **WHY + HOW TO THINK** (to be created)
- `CLAUDE.md` — AI project contract: **HOW THE AI BEHAVES + ENFORCES** (to be created)

`CLAUDE.md` is the AI-facing contract and must remain aligned with the actual project.
The Blueprint and Guideline are canonical supporting documents and must not be duplicated elsewhere.
...
The Vault is documentation storage. Its contents do not override current user instructions, the PRD, approved specifications, `CLAUDE.md`, or the Blueprint.
...
*The remainder of this document contains the detailed HRIS-specific technical specifications for implementation.*## 🏗️ Architecture Overview
...
│   ├── Schemas/
│   │   ├── EmployeeFormSchema.php
│   │   └── EmployeeInfolistSchema.php
│   └── Tables/
│       └── EmployeeTable.php
└── Portal/
    ├── Resources/
    │   ├── MyProfileResource.php
    │   └── Pages/
    │       ├── MyProfilePage.php
    │       └── MyDocumentsPage.php
```
...
### Architecture Council Approved Approach
...
### Security Council Compliance

The policy system now fulfills the Security Council requirements:
