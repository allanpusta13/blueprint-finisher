...
- `docs/00-project/ai-standard/standard.md` — the Vibe Coding development standard: **WHAT + WHEN**.
- `docs/00-project/ai-standard/guideline.md` — rationale and implementation guidance: **WHY + HOW TO THINK**.
...
## 16. Work-Type and Technology Profiles

The core contract is stack-neutral. Apply the smallest applicable profile and adapter.

Work profiles may include:
...
Technology adapters may define rules for specific technologies or tools. Do not assume a technology is present unless verified in the project.

For software projects, verify the actual installed language, framework, package, runtime, and test versions before relying on version-sensitive behavior.
